## Exercise 5
### No outputs since they weren't requested.
#### Code does not have the modulo 10^9 + 7 due to my debugging. However I will include how it would be done as a separate line ine tasks where it applies.
...
```
```python
#In order to get modulo (10**9 + 7) response, change return dp[n] as follows :
return dp[n] % (10**9 + 7)
```
...
```python
#In order to get modulo (10**9 + 7) response, change return array_sum as follows :
