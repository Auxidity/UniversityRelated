...
Description : Second iteration of api_call.py. Uses json payloads to communicate with openai api
"""
...
def openai_api_call(message_content, system_config):
    # api_key = REDACTED, insert your own key
